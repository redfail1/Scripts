...
function autoUpdate()
	...
	ToUpdate.VersionPath = "/justh1n10/Scripts/master/Ult%20Helper/ultHelper.version"
	ToUpdate.ScriptPath =  "/justh1n10/Scripts/master/Ult%20Helper/Ult%20helper%20-%20By%20Xivia.lua"
	ToUpdate.SavePath = SCRIPT_PATH.."/Ult helper - By Xivia.lua"
	ToUpdate.CallbackUpdate = function(NewVersion,OldVersion) _X:AddPrint("Updated to "..NewVersion..".") end
	ToUpdate.CallbackNoUpdate = function(OldVersion) _X:AddPrint("No Updates Found, script version " .. ToUpdate.Version) end
	ToUpdate.CallbackNewVersion = function(NewVersion) _X:AddPrint("New Version found ("..NewVersion.."). Please wait until its downloaded") end
	ToUpdate.CallbackError = function(NewVersion) _X:AddPrint("Error while Downloading. Please try again.") end
