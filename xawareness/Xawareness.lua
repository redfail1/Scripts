...
function _Tech:DeleteWard(object)
    ...
    if object.name == "SightWard" or object.name == "Ward_sight_Idle.troy" or object.name == "Ward_Sight_Idle.troy" or object.name == "VisionWard" then
    ...
    elseif object.name == "VisionWard" then
